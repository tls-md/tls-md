...
__export(external_tokens_exports, {
  angleLink_lookaround: () => angleLink_lookaround,
  ...
  isStartOfTitleTextMarkup_lookaround: () => isStartOfTitleTextMarkup_lookaround,
  notStartOfComment_lookaround: () => notStartOfComment_lookaround,
  notStartOfHeading_lookaround: () => notStartOfHeading_lookaround,
  ...
  regularLink_lookaround: () => regularLink_lookaround,
  sectionEnd_tokenizer: () => sectionEnd_tokenizer,
  sectionSpace_tokenizer: () => sectionSpace_tokenizer,
  sectionWordAngleLink_tokenizer: () => sectionWordAngleLink_tokenizer,
  sectionWordBold_tokenizer: () => sectionWordBold_tokenizer,
  sectionWordCode_tokenizer: () => sectionWordCode_tokenizer,
  sectionWordItalic_tokenizer: () => sectionWordItalic_tokenizer,
  sectionWordRegularLink_tokenizer: () => sectionWordRegularLink_tokenizer,
  sectionWordStrikeThrough_tokenizer: () => sectionWordStrikeThrough_tokenizer,
  sectionWordUnderline_tokenizer: () => sectionWordUnderline_tokenizer,
  sectionWordVerbatim_tokenizer: () => sectionWordVerbatim_tokenizer,
  sectionWord_tokenizer: () => sectionWord_tokenizer,
  shouldDedentHeading_lookaround: () => shouldDedentHeading_lookaround,
  shouldIndentHeading_lookaround: () => shouldIndentHeading_lookaround,
  stars_tokenizer: () => stars_tokenizer,
  tags_tokenizer: () => tags_tokenizer,
  titleWord_tokenizer: () => titleWord_tokenizer,
...
__export(parser_terms_exports, {
  ...
  sectionWordAngleLink: () => sectionWordAngleLink,
  sectionWordRegularLink: () => sectionWordRegularLink,
...
var isStartOfTitleTextBold = 36;
var isStartOfTitleTextItalic = 37;
var isStartOfTitleTextUnderline = 38;
var isStartOfTitleTextVerbatim = 39;
var isStartOfTitleTextCode = 40;
var isStartOfTitleTextStrikeThrough = 41;
var isStartOfTextBold = 42;
var isStartOfTextItalic = 43;
var isStartOfTextUnderline = 44;
var isStartOfTextVerbatim = 45;
var isStartOfTextCode = 46;
var isStartOfTextStrikeThrough = 47;
var PropertyDrawer = 1;
var TodoKeyword = 2;
var notStartOfPlanning = 48;
var notStartOfPropertyDrawer = 49;
var notStartOfHeading = 50;
var notStartOfComment = 51;
var shouldIndentHeading = 52;
var indentHeading = 53;
var shouldDedentHeading = 54;
var dedentHeading = 55;
var stars = 56;
var PlainLink = 3;
var isRegularLink = 57;
var isAngleLink = 58;
var sectionEnd = 59;
var sectionSpace = 60;
var titleWord = 61;
...
var endofline = 62;
var sectionword = 63;
var sectionwordBold = 64;
var sectionwordItalic = 65;
var sectionwordUnderline = 66;
var sectionwordVerbatim = 67;
var sectionwordCode = 68;
var sectionwordStrikeThrough = 69;
var sectionWordAngleLink = 70;
var sectionWordRegularLink = 71;
var Program = 5;
var ZerothSection = 6;
var CommentLine = 7;
var RegularLink = 8;
...
var TextBold = 10;
var TextItalic = 11;
var TextUnderline = 12;
var TextVerbatim = 13;
var TextCode = 14;
var TextStrikeThrough = 15;
var Heading = 16;
var Priority = 17;
var Title = 18;
var Section = 19;
...
function stringifyCodesLogString(charCodes) {
...
var isStartOfTextMarkup_lookaround = new import_lr2.ExternalTokenizer((input, stack) => {
...
var isStartOfTitleTextMarkup_lookaround = new import_lr2.ExternalTokenizer((input, stack) => {
  const termsByMarker = /* @__PURE__ */ new Map([
...
function isStartOfTextMarkup(input, termsByMarker, noEndOfLine) {
...
var shouldIndentHeading_lookaround = new import_lr2.ExternalTokenizer((input, stack) => {
  const context = stack.context;
...
var shouldDedentHeading_lookaround = new import_lr2.ExternalTokenizer((input, stack) => {
  const context = stack.context;
...
var checkRegularLink = (innerBracketText) => {
...
var regularLink_lookaround = (orgLinkParameters2) => {
  return new import_lr2.ExternalTokenizer((input, stack) => {
    const initialPos = input.pos;
...
var angleLink_lookaround = (orgLinkParameters2) => {
  return new import_lr2.ExternalTokenizer((input, stack) => {
    const initialPos = input.pos;
...
function sectionWordLink(input, end, term) {
...
var sectionWordRegularLink_tokenizer = new import_lr2.ExternalTokenizer((input, stack) => {
  sectionWordLink(input, ["]".charCodeAt(0), "]".charCodeAt(0)], sectionWordRegularLink);
});
var sectionWordAngleLink_tokenizer = new import_lr2.ExternalTokenizer((input, stack) => {
  sectionWordLink(input, [">".charCodeAt(0)], sectionWordAngleLink);
});
var OrgContext = class {
  constructor(headingLevelStack, levelHeadingToPush) {
...
var myHighlightStyle = import_language3.HighlightStyle.define([
  ...
  // Title
  { tag: import_highlight2.tags.contentSeparator, class: "org-title org-heading" },
  // Planning
  ...
  // Priority
  { tag: import_highlight2.tags.unit, class: "org-priority org-heading" },
  // Tags
  { tag: import_highlight2.tags.tagName, class: "org-tags org-heading" },
  // TextBold
  { tag: import_highlight2.tags.strong, class: "org-text-bold org-section" },
  // TextItalic
  { tag: import_highlight2.tags.emphasis, class: "org-text-italic org-section" },
  // TextUnderline
  { tag: import_highlight2.tags.modifier, class: "org-text-underline org-section" },
  // TextVerbatim
  { tag: import_highlight2.tags.literal, class: "org-text-verbatim org-section" },
  // TextCode
  { tag: import_highlight2.tags.monospace, class: "org-text-code org-section" },
  // TextStrikeThrough
  { tag: import_highlight2.tags.strikethrough, class: "org-text-strikethrough org-section" },
  // Link
  { tag: import_highlight2.tags.link, class: "org-link org-section" }
]);
...
var LinkWidget = class extends import_view2.WidgetType {
  constructor(linkPath, displayText, linkHandler, navigateToFile) {
    super();
...
function loadDecorations(state, obsidianUtils) {
  ...
  (0, import_language4.syntaxTree)(state).iterate({
    enter(node) {
      ...
      if (node.type.id === parser_terms_exports.PlainLink || node.type.id === parser_terms_exports.RegularLink || node.type.id === parser_terms_exports.AngleLink) {
        ...
        builder.add(node.from, node.from + 1, import_view2.Decoration.replace({}));
        builder.add(node.to - 1, node.to, import_view2.Decoration.replace({}));
      }
    }
  });
  return builder.finish();
}
var orgmodeLivePreview = (obsidianUtils) => {
...
var OrgView = class extends import_obsidian.TextFileView {
  constructor(leaf, orgmodeParser) {
    ...
    this.extensions = [
      ...
      (0, import_language5.syntaxHighlighting)(myHighlightStyle),
    ...
    if ((_c = (_b = (_a = this.app) == null ? void 0 : _a.vault) == null ? void 0 : _b.config) == null ? void 0 : _c.vimMode) {
      this.extensions.push(vim()), // see https://github.com/replit/codemirror-vim/blob/ab5a5a42171573604e8ae74b8a720aecd53d9eb1/src/vim.js#L266
